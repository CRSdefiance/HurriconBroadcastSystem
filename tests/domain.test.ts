...
describe('broadcast asset URLs',()=>{
  it('allows managed images and existing supported sources',()=>{
    expect(broadcastImageAssetUrl('/assets/hurricon-broadcast/images/logo.png')).toBe('/assets/hurricon-broadcast/images/logo.png');
    expect(broadcastImageAssetUrl('/bundles/hurricon-broadcast/shared/brands/logo.svg')).toContain('/bundles/');
    expect(broadcastImageAssetUrl('https://example.com/slide.webp')).toContain('https://');
  });
